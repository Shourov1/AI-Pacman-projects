...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        #foodPostions = newFood.asList()
        #m_f = min(manhattanDistance(newPos, foodPostion) for foodPostion in foodPostions if foodPostion)
        ...
        for food in newFood.asList():
            ...
            if u < fMin and u != 0:
                fMin = u
        gMin = min(manhattanDistance(newPos, s.getPosition()) for s in newGhostStates)
